...
Below, we'll go through each method in R, applying it to the following model (recall this is the model we ended with in [Chapter 2](02_lmm.html#a-more-complex-model){target="_blank"}).  
```{r}
library(tidyverse)
library(lme4)
